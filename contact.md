...
<section class="section-block">
	<div class="contact-grid">
		...
		<article class="contact-card">
			...
			<h2><a href="https://github.com/SMcQueen2023">GitHub Projects</a></h2>
			<p>Selected repositories and hands-on technical work.</p>
		</article>
		<article class="contact-card">
			<p class="card-kicker">Additional work</p>
			<h2><a href="https://gitlab.com/scottmcqueen2023">GitLab</a></h2>
			<p>Additional public projects and experiments.</p>
		</article>
	</div>
</section>
